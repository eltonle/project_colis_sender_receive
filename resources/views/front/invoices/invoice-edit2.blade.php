                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="invoice_no" value="{{ $invoice->invoice_no }}" id="invoice_no" class="form-control form-control-sm font-bold" disabled style="background: #2962FF;color: #fff">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>Date</label>
                                            <input type="date" name="date" id="date" value="{{ $invoice->date }}" class="form-control datepicker form-control-sm" placeholder="YYY-MM-DD" disabled>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
                                ...
                                <section class="col-md-12">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group col-md-12" style="margin-top: 20px">
                                            ...
                                            <select name="customer_id" id="customer_id" class="form-control select2 select2-danger " data-dropdown-css-class="select2-gray">
                                        ...
                                        <div class="form-group col-md-12" style="margin-top: 20px">
                                            ...
                                            <select name="receive_id" id="receive_id" class="form-control select2 select2-danger " data-dropdown-css-class="select2-gray">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-gray" id="country_id" name="country_id">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="state_id" class="form-control select2 select2-danger" data-dropdown-css-class="select2-gray" id="state_id">
                                                ...
                                                <div class="card card-gray">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-gray" id="countryr_id" name="countryr_id">
                                                                    <option value="">Selectionner un Pays</option>
                                                                    @foreach ($countries as $country)
                                                                    <option value="{{ $country->id }}" {{
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-gray" id="stater_id" name="stater_id">
                                        ...
                                        <div class="card-header">
                                            <h3><i class="	fas fa-file-alt" style="color: #2c3e50"></i> Information
                                                ...
                                                <a href="javascript:void(0)" class="btn float-right btn-md pt-2" id="addBtn" title="Ajouter" style="background: #2962FF;color: #fff"><i class="fa fa-plus">
                                                        Ajouter</i></a>
                                            </h3>
                                        </div><!-- /.card-header -->
                                                    ...
                                                    <div class="">
                                                        <table class="table table-hover table-white" id="tableEstimate">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <input type="hidden" name="invoice_details[]" value="{{ $item->id }}">
                                                                    <td>

                                                                        <input type="text" class="form-control" style="min-width: 130px;" id="model_marque" name="model_marque[]" value="{{ $item->model_marque }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control" style="min-width: 160px;" id="chassis" name="chassis[]" value="{{ $item->chassis }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control " style="width: 50px;" id="length" name="longueur[]" value="{{ $item->longueur }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control " style="width: 50px;" id="width" name="largeur[]" value="{{ $item->largeur }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control " style="width: 50px;" id="height" name="hauteur[]" value="{{ $item->hauteur }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control unit_price" style="width: 100px;" id="unit_price" name="unit_price[]" value="{{ $item->unit_price }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control total qty" style="width: 50px;" id="qty" name="qty[]" value="{{ $item->qty }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control item_total" readonly style="width: 100px;" id="item_total" name="item_total[]" value="{{ $item->item_total }}">
                                                                    </td>
                                                        ...
                                                        <table class="table table-hover table-white" id="tableSommation">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right; padding-right: 30px; width:100px;">
                                                                        <input type="text" class="form-control text-right" id="sub_total" name="sub_total" value="{{ $total_sum }}">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="5" class="text-right">Tax</td>
                                                                    <td style="text-align: right; padding-right: 30px; width:210px;">
                                                                        <input type="text" class="form-control text-right bg-gray-900" id="tax_1" name="tax_1" value="0" readonly>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right; padding-right: 30px; width:210px;">
                                                                        <input type="text" class="form-control text-right discount" id="discount" name="discount_amount" value="10" style="background-color: #55efc4">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right; padding-right: 30px; width:210px;">
                                                                        <input class="form-control text-right bg-danger" type="text" id="grand_total" name="total_amount" value="{{ $invoice['payement']['total_amount'] }}" readonly>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                        ...
                                        <div class="card-body row">
                                            <div class="form-group col-md-4">
                                                <label for="" style="font-weight:bold ">Montant versé <i class="fas fa-money-bill text-danger"></i></label>
                                                <input type="text" name="paid_amount" class="form-control " value="{{ $invoice['payement']['paid_amount'] }}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="status_livraison" class="form-control  " data-dropdown-css-class="select2-danger" id="status_livraison">
                                                    ...
                                                    <option {{ $invoice->status_livraison ==="en embarcation" ?
                                                            'selected' : '' }} value="en embarcation">
                                                        en embarcation
                                                    </option>
                                                    <option {{ $invoice->status_livraison ==="en cours
                                                            d'expedition" ? 'selected' : '' }} value="en cours d'expedition">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select name="unit_id" class="form-control" data-dropdown-css-class="select2-danger" id="package_id">
                                            ...
                                            <div class="">
                                                <label for="descrip" class="form-label" style="font-weight:bold ">
                                                    Description</label>
                                                <textarea name="description" id="descrip" class="form-control" rows="3" placeholder="entrer une description">
                                                {{ $invoice->description }}
                                                </textarea>
