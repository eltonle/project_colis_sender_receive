                        ...
                        <div class="card">
                            ...
                            <section class="col-md-12">
                                ...
                                <div class="form-group col-md-12" style="margin-top: 20px">
                                    ...
                                    <select name="customer_id" id="customer_id" required class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="" style="font-weight:bold ">Status de l'expedition <i class="fas fa-dolly-flatbed text-danger"></i></label>
                                ...
                                <div class="col-sm-8" style="margin-left:20px;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label>Titre :</label>
                                                <input type="text" id="titre" class="form-control" placeholder="Titre" name="titre" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <!-- text input -->
