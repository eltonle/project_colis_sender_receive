...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="">
                    <form action="{{ route('invoices.update_invoice') }}" method="post" enctype="multipart/form-data" id="myForm">
                        @csrf
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="invoice_no" value="{{ $invoice->invoice_no }}" id="invoice_no" class="form-control form-control-sm font-bold" readonly style="background: #2962FF;color: #fff">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Date</label>
                                        <input type="date" name="date" id="date" value="{{ $invoice->date }}" class="form-control datepicker form-control-sm" placeholder="YYY-MM-DD" readonly>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            ...
                            <section class="col-md-12">
                                ...
                                <div class="form-group col-md-12" style="margin-top: 20px">
                                    ...
                                    <select name="customer_id" id="customer_id" class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray">
                                        <option value="0">Selectionner un Expediteur</option>
                                        @foreach ($customers as $customer)
                                        <option value="{{ $customer->id }}" @if ($invoice['payement']['customer_id']==$customer->id)? selected :'' @endif >
                                ...
                                <div class="form-group col-md-12" style="margin-top: 20px">
                                    ...
                                    <select name="receive_id" id="receive_id" class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray">
                                        <option value="0">Selectionner un Destinataire</option>
                                        @foreach ($receives as $receive)
                                        <option value="{{ $receive->id }}" @if ($invoice['payement']['receive_id']==$receive->id)? selected :'' @endif>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray" id="country_id" name="country_id">
                                                            <option value="">Selectionner un Pays</option>
                                                            @foreach ($countries as $country)
                                                            <option value="{{ $country->id }}" @if ($invoice['country']['id']==$country->id)? selected :'' @endif>{{
                                                                        $country->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="state_id" class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray" id="state_id">
                                                            <option value="">Selectionner une Ville</option>
                                                            @foreach ($states as $state)
                                                            <option value="{{ $state->id }}" @if ($invoice['state']['id']==$state->id)? selected :'' @endif>{{
                                                                        $state->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="card card-gray">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray" id="countryr_id" name="countryr_id">
                                                            <option value="">Selectionner un Pays</option>
                                                            @foreach ($countries as $country)
                                                            <option value="{{ $country->id }}" @if ($invoice['countryr']['id']==$country->id)? selected :'' @endif>{{
                                                                        $country->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control" data-dropdown-css-class="select2-gray" id="stater_id" name="stater_id">
                                                            <option value="">Selectionner une Ville</option>
                                                            @foreach ($states as $state)
                                                            <option value="{{ $state->id }}" @if ($invoice['stater']['id']==$state->id)? selected :'' @endif>{{
                                                                        $state->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card  card-tabs">
                                            ...
                                            <div id="card-container" class=" row  m-1">
                                                @foreach($invoice->colis_dimensions as $colis)
                                                <h1>{{$colis}}</h1>
                                                @endforeach
                                                <div>
                                                    <h1>kbrkrkkkk l</h1>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="paid_amount" class="form-control form-control-sm" placeholder="Entrer un Montant" value="{{$invoice->payement->paid_amount}}" id="paid_amount">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="entrepot_id" class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-danger" id="package_id">
                                    ...
                                    <div class="form-group">
                                        <label for="package_id" style="font-weight:bold ">
                                            Description</label>
                                        <textarea name="description" class="form-control col-md-12">{{ $invoice->description }}</textarea>
...
<script>
    function sumAjax() {
        // Récupérez la valeur de l'input hidden
        var inv_id = $('#inv_id').val();
        $.ajax({
            url: "{{ route('sommeTotalEdit') }}",
            type: 'GET',
            dataType: 'json',
            data: {
                inv_id: inv_id
...
<script>
    function refreshContent() {
        ...
        // getData
        $.ajax({
            url: "{{ route('getDataDimEdit') }}", //AJOUTER
            type: 'GET',
            dataType: 'json',
            data: {
                inv_id: inv_id // Incluez la valeur dans les données de la requête
            },
            success: function(data) {
                console.log(data);
