...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data" id="myForm">
                        @csrf
                        {{-- left col
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3> Ajouter une Expedition
                                    <a href="{{ route('invoices.pending.list') }}" class="btn float-right btn-sm" style="background: #563DEA;color: #fff">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="invoice_no" value="{{ $invoice_no }}" id="invoice_no" class="form-control form-control-sm font-bold" readonly style="background: #2962FF;color: #fff">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Date</label>
                                        <input type="date" name="date" id="date" value="{{ $date }}" class="form-control datepicker form-control-sm" placeholder="YYY-MM-DD" readonly>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            ...
                            <section class="col-md-12">
                                ...
                                <div class="form-group col-md-12" style="margin-top: 20px">
                                    <label>NOM DE L'EXPEDITEUR</label> <button type="button" data-toggle="modal" id="btn_id" data-target="#modal-lg" title="Ajouter un Expediteur" class="btn btn-sm float-end" style="background: #563DEA; color: #fff;  margin-bottom: 5px;"><i class="fa fa-plus"></i></button>

                                    <select name="customer_id" id="customer_id" class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray">
                                ...
                                <div class="form-group col-md-12" style="margin-top: 20px">
                                    ...
                                    <button type="button" id="btn_id_1" title="Ajouter un Destinataire" data-toggle="modal" data-target="#modal-lg1" class="btn btn-sm float-end" style="background: #563DEA; color: #fff;  margin-bottom: 5px;"><i class="fa fa-plus"></i></button>

                                    <select name="receive_id" id="receive_id" class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray" id="country_id" name="country_id">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="state_id" class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray" id="state_id">
                                        ...
                                        <div class="card card-gray">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray" id="countryr_id" name="countryr_id">
                                                            <option value="">Selectionner un Pays</option>
                                                            @foreach ($countries as $country)
                                                            <option value="{{ $country->id }}">{{
                                                                        $country->name }}</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-gray" id="stater_id" name="stater_id">
                                                            <option value="">Selectionner une Ville</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <table class="table table-hover table-bordered" id="tableEstimate">
                                    <thead class="table-secondary">
                                        <tr>
                                            ...
                                            <th scope="col" class="NoPrint text-right">
                                                <button type="button" class="btn btn-sm" style="background: #563DEA; color: #fff" onclick="BtnAdd()"><i class="fa fa-plus"></i></button>
                                    ...
                                    <tbody id="TBody">
                                        <tr id="TRow">
                                            <td><input name="model_marque[]" type="text" class="form-control form-control-sm" placeholder="Model&Marque">
                                            </td>
                                            <td><input name="description_colis[]" type="text" class="form-control form-control-sm" placeholder="Description Colis"></td>
                                            <td><input name="chassis[]" type="text" class="form-control-sm form-control" value="0"></td>
                                            <td><input name="longueur[]" style="width: 50px" type="number" class="form-control form-control-sm" value="0"></td>
                                            <td><input name="largeur[]" style="width: 50px" type="number" class="form-control form-control-sm" value="0"></td>
                                            <td><input name="hauteur[]" style="width: 50px" type="number" class="form-control form-control-sm" value="0"></td>
                                            <td><input type="number" class="form-control form-control-sm text-end" name="unit_price[]" onchange="Calc(this);" value="0">
                                            </td>
                                            <td><input type="number" style="width: 50px" value="1" class="form-control form-control-sm text-end" name="qty[]" onchange="Calc(this);"></td>
                                            <td><input type="number" class="form-control form-control-sm text-end" name="item_total[]" value="0" readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                                {{-- DISPLAY COLIS --}}
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text text-danger font-weight-bold">Grand
                                                Total </span>
                                            <input type="text" class="form-control text-end" id="FNet" name="total_amount" readonly>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card  card-tabs">
                                            ...
                                            <div class="d-flex justify-content-between p-4">
                                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modal-lg-dim">
                                                    Ajouter un Colis Dimensionne
                                                </button>
                                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modal-lg-prix">
                                                    Ajouter un Colis A Prix
                                                </button>
                                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modal-lg-standard">
                                                    Ajouter un Colis Dimensionne
                                                </button>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="" style="font-weight:bold ">Entrer un Montant <i class="fas fa-donate text-danger"></i></label>

                                        <input type="text" name="paid_amount" class="form-control form-control-sm" placeholder="Entrer un Montant" value="0" id="paid_amount">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="" style="font-weight:bold ">Status Livraison <i class="fas fa-dolly-flatbed text-danger"></i></label>
                                        <select name="status_livraison" class="form-control select2 select2-danger form-control-sm" data-dropdown-css-class="select2-danger" id="status_livraison">
                ...
                <form action="{{ route('customers.storeExp') }}" method="post" id="myFomExp">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row col-md-12 ">
                            <div class="form-group col-md-4">
                                <label for="">Nom</label>
                                <input type="text" name="nom" class="form-control form-control-sm" placeholder="Nom du Client">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Prenom</label>
                                <input type="text" name="prenom" class="form-control form-control-sm" placeholder="Prenom du Client">
                            </div>
                            <div class="form-group col-md-4">
                                <label for=""> Email</label>
                                <input type="email" name="email" class="form-control form-control-sm" placeholder="Email du Client">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Address</label>
                                <input type="text" name="address" class="form-control form-control-sm" placeholder="Address du Client">
                            </div>
                            <div class="form-group col-md-4">
                ...
                <form action="{{ route('customers.storeDex') }}" method="post" id="myFomDex">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row col-md-12">
                            <div class="form-group col-md-4">
                                <label for="">Nom</label>
                                <input type="text" name="nomr" class="form-control form-control-sm" placeholder="Nom du recepteur">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Prenom</label>
                                <input type="text" name="prenomr" class="form-control form-control-sm" placeholder="prenom du recepteur">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Email</label>
                                <input type="email" name="emailr" class="form-control form-control-sm" placeholder="email du recepteur">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Address</label>
                                <input type="text" name="addressr" class="form-control form-control-sm" placeholder="Address du recepteur">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="">Phone</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="quantite" class="form-control" placeholder="Nombre de colis" name="quantite" value="1">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Largeur du colis" id="largeur" name="largeur">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Longueur du colis" id="longueur" name="longueur">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Hauteur du colis" id="hauteur" name="hauteur">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <!-- text input -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="poids" placeholder="Enter ..." name="poids">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-3 text-center " style="border:2px solid black;  margin-left:40px;">
                                <div class="row mx-auto ">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="prix_kilo" value="650" name="prix_kilo">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="conversion" value="1000" name="conversion">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top: 50px">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="prix" id="prix" class="form-control" value="0" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="prix" id="prix_unit" min="0" value="0" readonly class="form-control">
                            </div>
                            ...
                            <div class=" row">
                                ...
                                <div class="col-md-4">
                                    <input type="number" name="total" id="prix_total" min="0" value="0" readonly class="form-control ">
                                </div>
                            ...
                            <form action="" method="POST" id="formStand">
                                ...
                                <div class="row" style="width: 100%; margin-left: 4px; height:300px ;background:#f2f2f6;">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <textarea name="description" id="" class="form-control" placeholder="une description ..." cols="5" rows=""></textarea>
                                    </div>
