                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3> Lists des Entrepôts
                                <a href="{{ route('entrepots.create') }}" class="btn  float-right btn-sm" style="background: #563DEA;color: #fff">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a href="{{  route('entrepots.edit',$entrepot->id) }}" title="editer l'entrepot" class="dropdown-item"><span class="text-xs text-dark font-weight-bold"><i class="fa fa-eye"></i> Editer l'Entrepot</span>

                                                        </a>
                                                        <a href="{{ route('entrepots.show', ['entrepot' => $entrepot->id]) }}" title="entrepot et colis" class="dropdown-item"><span class="text-xs text-dark font-weight-bold"><i class="fas fa-truck-moving"></i> Entrepot et Colis </span>

                                                        </a>
                                                        <a href="{{ route('entrepots.show.decharge', ['entrepot' => $entrepot->id]) }}" title="entrepot et colis" class="dropdown-item"><span class="text-xs text-dark font-weight-bold"><i class="fas fa-truck-moving"></i> Entrepot et Colis dechargés </span>
                                                        ...
                                                        <div class="dropdown-item">
                                                            ...
                                                            <form method="POST" action="{{  route('entrepots.delete', $entrepot->id) }}">
                                                                @csrf
