                    ...
                    <div class="card">
                        ...
                        <div class="card-header ">
                            <h4><strong>Listes des Colis de l'Entrepôt</strong>
                                ...
                                <a href="{{ route('entrepotListes.pdf', $entrepot) }}" target="_blank"
                                    class="btn btn-success float-right btn-sm ml-2">
