                                    ...
                                    <div class="form-group" style="margin-bottom: 30px;">
                                        ...
                                        <div class="float-end ">
                                            <div class="">
                                                ...
                                                <select name="entrepot_id" class="form-control select2 select2-cyan" data-dropdown-css-class="select2-cyan" id="entrepot_id">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input" id="colis-{{ $ul->id }}" name="colis[]" value="{{ $ul->id }}">
                                                    </div>
                                                </td>
